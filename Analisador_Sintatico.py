...
class AnalisadorSintatico:
    def ErroSintatico(self, fs, nt, te):
        print(f"\n----------------------Erro Sintatico-------------------------")
    ...
    def verificar_palavra(self, tokens, tabela,terminais, nao_terminais):
        sentenca = tokens
    ...
    def verificar_sentenca(self, tokens, tabela, terminais, n_terminais):
        verificador = self.verificar_palavra(
        ...
        if len(verificador) == 3:
            ...
            self.ErroSintatico(sent_completa, nt, te)
        else:
    ...
    def analisar(self, gramatica, tokens):
        ...
        self.verificar_sentenca(tokens, tabela, terminais, n_terminais)
